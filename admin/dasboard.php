...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0 text-center" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
                target="_blank">
                <span class="ms-1 font-weight-bold text-white"> SHOPSTAR</span>
            </a>
        </div>
